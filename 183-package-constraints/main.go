...
// ordered constraint contains these 3 constraints - integer, float, string
// integer constraint contains all types of int's, both signed and unsigned
// float constraint contains all types of float's, both signed and unsigned
